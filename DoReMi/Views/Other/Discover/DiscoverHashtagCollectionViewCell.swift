//
//  DiscoverHashtagCollectionViewCell.swift
//  DoReMi
//
...
class DiscoverHashtagCollectionViewCell: UICollectionViewCell {
    static let identifier = "DiscoverHashtagCollectionViewCell"
